...
function App() {
  ...
  return (
    <div className="flex flex-col items-center gap-y-3 bg-white py-5 px-10 min-w-80 shadow-lg shadow-black md:gap-y-12 h-full"> {/* Page container */}
        ...
        {flagArray &&
          flagArray.map((flagTime, i) => (
            <>
              <span
                key={i}
                className="text-2xl font-bold tracking-wide opacity-75"
              >
